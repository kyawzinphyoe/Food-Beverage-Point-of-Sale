...
<nav class="navbar navbar-default" style="background: #2874A6;color: white;">
    <div class="container-fluid" style="color: white;">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                endforeach;
                ?>
                <li> <a href="../../cat.php" style="color:white"><i class="fa fa-shopping-cart"></i>  <span class="badge"> <?php echo $totalqty; ?></span></a>  </li>
            </ul>
