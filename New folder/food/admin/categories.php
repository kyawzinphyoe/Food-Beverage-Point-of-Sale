...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            unset($_SESSION['info']);
            ?>
            <div class="panel panel-primary" style="background: #ffcc80;">
                <div class="panel-heading" style="background: saddlebrown;border: none;border: 1px solid #ffcc80;">Add Categories</div>
                <div class="panel-body">
                    <form action="post_categories.php" method="post">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-lg" style="background: saddlebrown;border: none;">Add Product</button>
                        </div>
                    </form>
                </div>
            </div>
